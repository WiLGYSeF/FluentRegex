...
public class PatternTest
{
    ...
    public void EmailRegex()
    {
        ...
        var expected = @"^(?<local>(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?[A-Z\^-}/-9#-'!*+\-=?]+(?:\.[A-Z\^-}/-9#-'!*+\-=?]+)*(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?""(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x23-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x21\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?""(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?[A-Z\^-}/-9#-'!*+\-=?]+(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?""(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x23-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x21\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?""(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?)(?:\.(?:(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?[A-Z\^-}/-9#-'!*+\-=?]+(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?""(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x23-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x21\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?""(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?))*)@(?<domain>(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?[A-Z\^-}/-9#-'!*+\-=?]+(?:\.[A-Z\^-}/-9#-'!*+\-=?]+)*(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\[(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x5A\x5E-\x7E]|[\x01-\x08\x14-\x1F\x11\x12\x7F]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\](?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?[A-Z\^-}/-9#-'!*+\-=?]+(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:\.(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?[A-Z\^-}/-9#-'!*+\-=?]+(?:(?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\((?:(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?(?:[\x21-\x27\x2A-\x5B\x5D-\x7F\x01-\x08\x14-\x1F\x11\x12]|\\[ -\x7E\t]|\\[\x01-\x08\x14-\x1F\x11\x12\x7F\n\r]))*(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?\))+(?:(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?|(?:[ \t]*\r\n)?[ \t]+|[ \t]+(?:\r\n[ \t]+)*)?)*)$";
        var patternString = addrSpec.ToString();
        patternString.ShouldBe(expected);
    }
}
